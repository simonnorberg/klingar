...
/**
 * Interface representing either Local or Remote Playback. The {@link .service.MusicService} works
...
public interface Playback {
   ...
   *                        callback.onPlaybackStatusChanged will be called after changingthe state.
   */
  ...
  /**
   * Get the current {@link android.support.v4.media.session.PlaybackStateCompat#getState()}
   */
  int getState();
  ...
  /**
   * Set the current mediaId. This is only used when switching from one playback to another.
   *
  ...
  interface Callback {
     ...
     * Implementations can use this callback to update playback state on the media sessions.
     */
